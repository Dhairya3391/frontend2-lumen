    ...
    <div className="min-h-screen bg-[#F9F6F2]">
      ...
      <main className="container mx-auto px-4 py-12 lg:py-20">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          >
            Making advanced cardiovascular risk assessment accessible,
            understandable, and less intimidating for everyone.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          ...
          >
            ...
            <h3 className="text-2xl font-serif font-bold text-[#1F1F1F] mb-4">
              Human-Centric Design
            </h3>
            <p className="text-[#8A817C] leading-relaxed">
              Medical data is often complex and scary. We designed Lumen to be
              calm, clear, and reassuring. Instead of raw medical jargon, we use
              visual metaphors and plain language (like explaining Systolic vs
              Diastolic pressure) to help you understand your body better.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-[#8A817C] leading-relaxed">
              Powered by a Random Forest Machine Learning model, Lumen analyzes
              multiple health markers instantly. We don&apos;t just give you a
              number; we simulate how changes in your lifestyle—like weight loss
              or better sleep—can actually improve your heart age in real-time.
            </p>
          </motion.div>
        </div>
        ...
        <div className="max-w-4xl mx-auto bg-[#1F1F1F] rounded-[2.5rem] p-8 lg:p-12 text-white relative overflow-hidden">
          <div className="relative z-10 text-center">
            ...
            <p className="text-lg opacity-80 mb-8 max-w-2xl mx-auto">
              To democratize health insights. We believe that knowing your risk
              is the first step to preventing cardiovascular disease. Lumen
              provides a private, secure, and easy-to-use tool to start that
