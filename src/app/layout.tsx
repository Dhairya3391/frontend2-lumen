      ...
      >
        ...
        <footer className="border-t border-[#EAE0D5] bg-white/50 py-8">
            <div className="container mx-auto px-4 text-center text-sm text-[#8A817C]">
                ...
                <p>© {new Date().getFullYear()} Created by <span className="font-semibold text-[#FF4D8C]">NoobOkay</span>.</p>
                <p className="mt-2 text-xs opacity-70">AI predictions are for informational purposes only. Consult a doctor for medical advice.</p>
            </div>
        </footer>
      </body>
    </html>
