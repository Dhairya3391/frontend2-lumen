        ...
        <CardContent className="flex flex-col items-center py-6">
          ...
          <div className="relative flex items-center justify-center mb-6">
            ...
            <div className="absolute flex flex-col items-center">
              ...
              <span className="text-xs text-slate-500 font-medium uppercase">Risk</span>
            </div>
          </div>

          <div className={`flex items-center gap-2 px-4 py-1.5 rounded-full ${bgColor} bg-opacity-10 mb-4`}>
            <Icon className={`h-5 w-5 ${color}`} />
            <span className={`font-semibold ${color}`}>{result.risk_level} Risk</span>
          </div>
